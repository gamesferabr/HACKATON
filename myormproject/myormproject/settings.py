"""
Django settings for myormproject project.
...
SECRET_KEY = 'django-insecure-6du=_$8y0az@^7*!gg*17dul*g$(rrgdouak0wl#_44%69ex&+'
...
WSGI_APPLICATION = 'myormproject.wsgi.application'
